...
class App extends Component {
    ...
    slabCollided = () => {
        ...
        this.slab2Move = !this.slab2Move;
        if (this.slab1Move) {
            this.moveDownToHideSlab1()
            this.bringDownSlab2()
            this.moveSlab1()
        }
        else {
            this.moveDownToHideSlab2()
            this.bringDownSlab1()
            this.moveSlab2()
        }
    }
    ...
    moveDownToHideSlab1 = () => {
        ...
        let diff = window.innerHeight - this.slab2Position.y;
    ...
    bringFromTopSlab1 = () => {
        ...
        let moveToTop = () => {
            ...
            Body.setPosition(slab, {
                x: slab.position.x,
                y: window.innerHeight - this.slab2Position.y
            })
            // console.log(diff)
        }
    ...
    bringDownSlab1 = () => {
        ...
        let diff = this.slab2.position.y - this.slab1Position.y;
        let move = () => {
            diff--;
            Body.translate(slab, { x: 0, y: 1 })
            if (diff > 0)
    ...
    bringDownSlab2 = () => {
        ...
        let move = () => {
            ...
            Body.setPosition(slab, {
                x: slab.position.x,
                y: window.innerHeight - this.slab1Position.y
            })
        }
        requestAnimationFrame(move);
    }
